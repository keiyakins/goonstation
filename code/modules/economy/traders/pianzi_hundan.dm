...
/datum/commodity/trader/pianzi/metal
	...
	price_boundary = list(PAY::UNTRAINED/10,PAY::TRADESMAN/10)
...
/datum/commodity/trader/pianzi/concgloves
	...
	amount = 2
	price_boundary = list(PAY::TRADESMAN*2,PAY::TRADESMAN*5)
...
/datum/commodity/trader/pianzi/wine
	...
	amount = 8
	price_boundary = list(PAY::UNTRAINED/10,PAY::EXECUTIVE/10)
...
/datum/commodity/trader/pianzi/telecrystal
	...
	price_boundary = list(PAY::DOCTORATE,PAY::EXECUTIVE)
...
/datum/commodity/trader/pianzi/artifact
	...
	price_boundary = list(PAY::DOCTORATE,PAY::EMBEZZLED)
